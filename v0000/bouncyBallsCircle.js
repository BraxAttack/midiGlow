...
function bouncyBalls(){
    for (let i = 0; i < bouncyBallsCircleArray.length; i++){

        bouncyBallsCircleArray[i].update()
    }
...
function createCircle(xValue, yValue, color){
    ...
    bouncyBallsCircleArray.push(new Circle(x, y, dx, dy, radius, color))
